			...
			<p class="navig">首页&nbsp;>&nbsp;个人信息</p>
				<div class="left-box">
					<ul>
						...
						<li><a class="active2" href="${pageContext.request.contextPath}/FrontPage/user_info_3.jsp">退园申请</a></li>
		...
		<div id="CP_quit_add" class="all-mark">
			<div class="mark-house-op acc_op">
				<div class="mark-heading">
					<p>退园处理新增</p>
					<img id="Cqa_quit" class="del-img" title="关闭" src="${pageContext.request.contextPath}/FrontPage/img/del.png"/>
				</div>
				<div class="dpm_op_content form-inline">
					...
					<input class="form-control owidth" type="text" /><br /><br />
					<lable>退租状态：</lable>
					<input type="radio" />&nbsp;保持已装修状态&nbsp;&nbsp;&nbsp;
					<input type="radio" />&nbsp;拆除装修恢复原状<br /><br />
					<lable>退租类型：</lable>
					<input type="radio" />&nbsp;合同到期&nbsp;&nbsp;&nbsp;
					<input type="radio" />&nbsp;提前退租<br /><br />
				</div>
				<div class="d-other">							
					<div class="d-subm">
