						...
						<div class="x_panel">
							...
							<div class="x_content">
								<div class="form-group form-inline">
									<div class="flow_div">
										<label class="lablemar">入园申请审批流程:&nbsp;&nbsp;&nbsp;
				            			    <select class="form-control">
				            			    	<option>--请选择--</option>
										        <option selected="selected">招商部</option>
										        <option>行政部</option>
										        <option>后勤部</option>
										    </select>
				            			</label>
										...
										<label class="lablemar">
				            			    <select class="form-control">
										        ...
										        <option>园长</option>
										        <option>主任</option>
										        <option selected="selected">副主任</option>
										    </select>
				            			</label>
				            			<img src="img/jiantou2.png"/>
										<label class="lablemar">
				            			    <select class="form-control">
										        <option>--请选择--</option>
										        <option>园长</option>
										        <option selected="selected">主任</option>
										        <option>副主任</option>
										    </select>
				            			</label>
				            			<img src="img/jiantou2.png"/>
										<label class="lablemar">
				            			    <select class="form-control">
										        ...
										        <option>主任</option>
										        <option>副主任</option>
										        <option selected="selected">管委领导</option> 
										    </select>
				            			</label>
				            			<img src="img/jiantou2.png"/>
										<label class="lablemar">
				            			    <select class="form-control">
										        <option>--请选择--</option>
										        <option selected="selected">综合部</option>
										    </select>
				            			</label>
									</div>
									<div class="flow_div">
										<label class="lablemar">退园申请审批流程:&nbsp;&nbsp;&nbsp;
				            			    <select class="form-control">
				            			    	<option>--请选择--</option>
										        <option>招商部</option>
										        <option>行政部</option>
										...
										<label class="lablemar">
				            			    <select class="form-control">
										        ...
										        <option>主任</option>
										        <option>副主任</option>
										        <option selected="selected">中心领导</option>
										    </select>
				            			</label>
									</div>
									<div class="flow_div">
										<label class="lablemar">已入园企业申请审批流程:&nbsp;&nbsp;&nbsp;
				            			    <select class="form-control">
				            			    	<option>--请选择--</option>
										        <option selected="selected">招商部</option>
										        <option>行政部</option>
